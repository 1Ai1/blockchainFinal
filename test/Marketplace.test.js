...
contract("Marketplace", ([deployer, seller, buyer]) => {
  ...
  describe("deployment", async () => {
    ...
    it("has a name", async () => {
      ...
      assert.equal(name, "Land registry system");
    });
  });
  ...
  describe("products", async () => {
    ...
    it("creates products", async () => {
      ...
      assert.equal(event.name, "Land Dubai", "name is correct");
      ...
      await await marketplace.createProduct("Land Dubai", 0, { from: seller })
        .should.be.rejected;
    });
    ...
    it("lists products", async () => {
      ...
      assert.equal(product.name, "Land Dubai", "name is correct");
